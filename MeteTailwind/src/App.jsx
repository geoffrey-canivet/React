            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 justify-center m-5">
                    ...
                    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="flex justify-between px-4 pt-3 pb-3">
                            <h5 className="text-xl font-medium text-gray-900 dark:text-white"><FontAwesomeIcon className="mr-4" icon={faHouse} style={{color: "#74C0FC",}} />Charges</h5>
                            <div className="">
                        ...
                        {/*CARD CHARGE FOOTTER*/}
                        <div className="flex justify-between px-4 py-4 bg-white dark:bg-gray-800">
                            <div className="flex-1 text-center border-r border-gray-300 dark:border-gray-600">
                                <div className="font-medium text-gray-900 whitespace-nowrap dark:text-white">557 €</div>
                                <div className="text-xs">Mois</div>
                            </div>
                            <div className="flex-1 text-center border-r border-gray-300 dark:border-gray-600">
                                <div className="font-medium text-gray-900 whitespace-nowrap dark:text-white">557 €</div>
                                <div className="text-xs">Trimestre</div>
                            </div>
                            <div className="flex-1 text-center">
                                <div className="font-medium text-gray-900 whitespace-nowrap dark:text-white">557 €</div>
                                <div className="text-xs">Année</div>
                            </div>
                        </div>
                ...
                <div
                        ...
                        <div className="flex justify-between px-4 pt-3 pb-3">
                            <h5 className="text-xl font-medium text-gray-900 dark:text-white">Crédit</h5>
                            <div className="">
                                <button id="dropdownButton" data-dropdown-toggle="dropdown"
                                        className="inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5"
                                        type="button">
